...
nohup python ./train_abs_spe_contrast.py -mode train -data_path bert_data_spe_contrast/all/ -model_path models/bart_spe_contrast_csds --model_name ./bart_base_chinese --sample_num 3 --role_lambda 0.6 --tokenizer_name ./bert_chinese --max_turn_range 8 --temperature 0.1 -device_id 1 >train_bart_spe_contrast_csds.log 2>&1 &
python ./train_abs_spe_contrast.py -mode test -data_path bert_data_spe_contrast/all/ -model_path ./models/bart_spe_contrast_csds --model_name ./bart_base_chinese --checkpoint_path ./models/bart_spe_contrast_csds/abs_bart_base.tar -device_id 2
