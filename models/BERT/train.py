...
if __name__ == '__main__':
    ...
    parser.add_argument("-result_dir", default='./logs')
    ...
    parser.add_argument("-max_src_len", default=1200, type=int)
    ...
    parser.add_argument("--role_lambda", default=0.5, type=float, help="")
    ...
    print('Device ID %d' % args.device_id)
